...
export function Login() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="neo-card w-full max-w-md p-8 bg-neo-cyan/10">
        <h1 className="text-4xl font-black uppercase tracking-tighter mb-6 text-center bg-white border-2 border-black inline-block px-4 py-2 rotate-[-2deg] mx-auto block w-fit">Welcome Back</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button type="submit" className="neo-button w-full mt-4 !bg-neo-primary">
            Log In
          </button>
        </form>
        ...
        <p className="mt-6 text-center font-bold">
          Don't have an account? <Link to="/register" className="text-neo-primary hover:underline bg-white px-1">Register</Link>
        </p>
      </div>
    </div>
  );
